...
const resources = {
  en: {
    translation: {
      ...
      "warning.message":
        "This tour is in {{tourLang}} and your guide will be speaking in {{tourLang}} language but your site language is set to {{siteLang}}. The content may not match your selected language.",
      "warning.browseButton": "Browse {{siteLang}} Tours",
      "tours.allDestinations": "All Destinations",
      "tours.allDepartures": "Departure City",
  ...
  tr: {
    translation: {
      ...
      "warning.title": "Uyarı",
      "warning.message":
        "Bu tur {{tourLang}} dilindedir ve rehberiniz {{tourLang}} dilinde konuşacaktır, ancak site diliniz {{siteLang}} olarak ayarlıdır. İçerik seçilen dilinizle eşleşmeyebilir.",
      "warning.browseButton": "Türkçe Turlara Göz At",
      "tours.allDestinations": "Tüm Rotalar",
      "tours.allDepartures": "Kalkış Şehri",
  ...
  de: {
    translation: {
      ...
      "warning.message":
        "Diese Tour ist auf {{tourLang}} und Ihr Guide wird {{tourLang}} sprechen, aber Ihre Website-Sprache ist auf {{siteLang}} eingestellt. Der Inhalt stimmt möglicherweise nicht mit Ihrer gewählten Sprache überein.",
      "warning.browseButton": "{{siteLang}} Touren durchsuchen",
      "tours.allDestinations": "Alle Ziele",
      "tours.allDepartures": "Abfahrtsort",
  ...
  fr: {
    translation: {
      ...
      "tours.youMayAlsoLike": "Vous aimerez peut-être aussi ceux-ci",
      "tours.recommendedBadge": "RECOMMANDÉ",
      "tours.expertGuide": "Guide expert inclus",
      "tours.departureFrom": "Départ de",
      "tours.multipleDestinations": "Destinations multiples",
      "tours.exploreSubtitle":
      ...
      "warning.message":
        "Ce circuit est en {{tourLang}} et votre guide parlera {{tourLang}}, mais la langue de votre site est définie sur {{siteLang}}. Le contenu peut ne pas correspondre à votre langue sélectionnée.",
      "warning.browseButton": "Parcourir les circuits {{siteLang}}",
      "tours.allDestinations": "Toutes les destinations",
      "tours.allDepartures": "Ville de départ",
  ...
  es: {
    translation: {
      ...
      "tours.multipleDestinations": "Múltiples destinos",
      "tours.exploreSubtitle":
      ...
      "warning.message":
        "Este tour está en {{tourLang}} y su guía hablará {{tourLang}}, pero el idioma de su sitio está configurado en {{siteLang}}. El contenido puede no coincidir con su idioma seleccionado.",
      "warning.browseButton": "Ver tours en {{siteLang}}",
      "tours.allDestinations": "Todos los destinos",
      "tours.allDepartures": "Ciudad de salida",
  ...
  ru: {
    translation: {
      ...
      "warning.message":
        "Этот тур на {{tourLang}}, и ваш гид будет говорить на {{tourLang}}, но язык вашего сайта установлен на {{siteLang}}. Содержимое может не соответствовать выбранному языку.",
      "warning.browseButton": "Посмотреть туры на {{siteLang}}",
      "tours.allDestinations": "Все направления",
      "tours.allDepartures": "Город отправления",
  ...
  ja: {
    translation: {
      ...
      "warning.title": "警告",
      "warning.message":
        "このツアーは{{tourLang}}で、ガイドは{{tourLang}}で案内しますが、サイトの言語は{{siteLang}}に設定されています。コンテンツが選択した言語と一致しない場合があります。",
      "warning.browseButton": "{{siteLang}}のツアーを見る",
      "tours.allDestinations": "すべての目的地",
      "tours.allDepartures": "出発都市",
